	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http
			.authorizeHttpRequests(authConfig -> {
				authConfig.requestMatchers(HttpMethod.GET, "/", "/login", "/error",
						"/login-error", "/logout","/home/**",
						"/register", "/success",
						"/css/**").permitAll();
				authConfig.requestMatchers(HttpMethod.POST, "/register/success").permitAll();
			...
			.formLogin(login -> {
				...
				login.loginProcessingUrl("/sign-in");
				login.defaultSuccessUrl("/home/wellcome");
